...
fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${acaVaLaAPIKey}&with_genres=${id}`)
.then(function(resp){
    return resp.json()
...
// fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${acaVaLaAPIKey}&with_genres=${id}`)
// .then(function(resp){
//     return resp.json()
